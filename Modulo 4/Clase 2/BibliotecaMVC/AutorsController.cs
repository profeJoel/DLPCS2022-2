...
namespace BibliotecaMVC
{
    ...
    {
        private readonly BibliotecaMVCContext _context;

        public AutorsController(BibliotecaMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BibliotecaMVCContext.Autor'  is null.");
            }
            var autor = await _context.Autor.FindAsync(id);
            if (autor != null)
            {
